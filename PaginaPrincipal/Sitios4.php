...
<?php
  ...
  ?>
 <?php
 $sql="SELECT Nombre,descripcion_corta,descripcion_larga,precio,ubicacion,punto_lugar,Foto_fondo,foto1,foto2,foto3,Punto_lugar,Ubicacion from lugares_turisticos where Cod_lugar_turistico=3";
 ...
 ?>
  ...
  <h2><?php echo $mostrar['Nombre']?></h2>
      ...
      <nav id="Carrito">
          ...
          $consulta = "SELECT * FROM lugares_turisticos WHERE Cod_lugar_turistico= 3";
