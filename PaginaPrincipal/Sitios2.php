    ...
    <main>
        ...
        <div class="texto">
          ...
          <p>Ms.n.m: 1550m<br> 
            ...
            Dist. desde Bogotá. 380km <br> 
            Dis. desde Neiva.96km <br> 
            Dis.desde Gigante. 5km <br> 
            Acceso.<br> Carro normal hasta
            taquilla. Camioneta 4x4 hasta
            la cubre (se paga adicional al
            pago de la entrada a cargo del
            parque temático).<br> 
            Dificultad del terreno.<br>  
            Media baja.  
            Vestimenta.
          ...
          <div class="texto2">
           ...
           <p>
            ...
            3hr mínimo con grupo menor
            a 5 personas. 5 a 15 personas
            4hr. 15 a 30 personas 5hr. <br> 
            Implem. de seguridad. NA <br> 
            Condiciones del clima. <br> 
            Relativamente seco, gran
            parte del día con lluvias
            imprevistas que duran poco
            tiempo. <br> 
            Actividad Turística.<br> 
            Caminata conociendo varios
            miradores, Observación de
            aves, Tour fotográfico. <br> 
