...
<head>
    ...
    <link rel="stylesheet" href="/ruta360/usuarios/PaginaPrincipal/Estilos/EstilosSitios3.css">
</head>
<body>
    <header>
        <div> 
         ...
         <aside>
            <nav id="boton"> 
              ...
              <div class="Ubicación">
                <div class="Caja"> 
                <ul>
                 <a href="https://www.google.com/maps/dir/2.4110496,-75.516023/mirador+la+cacica+gigante+huila/@2.4374975,-75.5468697,14z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x8e3b2f3fef64c5b7:0xc744dfebb2a3356c!2m2!1d-75.5427142!2d2.4674446"><img src="/ruta360/imagenes/Ubicación.png"></a>
                </ul> 
                </div>
              </div> 
                  ...
                  <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img src="/ruta360/imagenes/MiradorCacica.png" width="50%" height="300px" class="d-block w-100" alt="banner1">
                      </div>
                      <div class="carousel-item">
                        <img src="/ruta360/imagenes/MiradorCacica2.png" width="50%" height="300px" class="d-block w-100" alt="banner2">
                      </div>
                      <div class="carousel-item">
                        <img src="/ruta360/imagenes/MiradorCacica3.png" width="50%" height="300px" class="d-block w-100" alt="banner3">
                      </div>
                    </div>
                          ...
                          <div class="img">
                            <div class="img2">
                              <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                  <div class="carousel-item active">
                                    <a href="/ruta360/usuarios/PaginaPrincipal/Paginaphp/Sitios2.html"><img src="/ruta360/imagenes/MiradorCacica.png" class="d-block w-100" alt="baneer1"></a>
                                  </div>
                                  <div class="carousel-item">
                                    <a href="/ruta360/usuarios/PaginaPrincipal/Paginaphp/Sitios2.html"><img src="/ruta360/imagenes/MiradorCacica2.png" class="d-block w-100" alt="banner2"></a>
                                  </div>
                                  <div class="carousel-item">
                                    <a href="/ruta360/usuarios/PaginaPrincipal/Paginaphp/Sitios2.html"><img src="/ruta360/imagenes/MiradorCacica3.png" class="d-block w-100" alt="banner3"></a>
                                  </div>
                                </div>
                              </div>
                             </div>
