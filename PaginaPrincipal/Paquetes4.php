...
<?php 
           ...
           ?>
          <?php
          $sql="SELECT Nombre,Foto_fondo,Foto1,Foto2,Foto3,Precio,Punto_paquete,Descripcion,Itinerario,Incluye,Recomendaciones from paquetes_turisticos where Cod_paquete=12";
  ...
  <form action="../php/carritoCompras.php" method="post">
          ...
          $consulta = "SELECT * FROM paquetes_turisticos WHERE Cod_paquete= 12";
