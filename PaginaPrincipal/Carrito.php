...
<head>
    ...
    <link rel="stylesheet" href="/ruta360/usuarios/PaginaPrincipal/Estilos/EstilosCarrito.css">
</head>
<body>
    <header>
        <div> 
    ...
    <main>
        <div class="Carrito"> 
        <img src="/ruta360/imagenes/Carrito2.png.png" alt="Carrito">
        </div>
        <h1>Carrito</h1> 
        <div class="Caja">
           <div class="subcaja">
    ...
    <div class="Total">
      ...
      <nav id="Comprar"> 
        <ul>
          <li><a href="/ruta360/usuarios/PaginaPrincipal/Paginaphp/Pago.php"> Comprar </a></li>
        </ul>
      </nav>
    </main>
