        ...
        <div class="reservas">
            <div class="subreservas">
                ...
                <ol>
                    ...
                    <li><p class="tx" ><?php $_SESSION['reservas']=$mostrar['id_reservas'];  echo $mostrar['id_reservas'];?></p><a href="/php/confirmar.php?confirmar=<?php echo $mostrar ['confirmar'];?>">Confirmar</a><a onclick="mostrar()">Reprogramar</a></li>
                    </form>    
                </ol>
                <?php }?>
            </div>
