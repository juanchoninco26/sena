    <footer id="menu">
        <nav class="caja">
            <ul class="subcaja">
                <li><a href="/user-externo/promociones.php">Puntos</a></li> 
                <li><a href="/user-externo/historial.php" class="h">Historial</a></li> 
                <li><a href="/user-externo/explorar-sitios.php" class="h">Explorar Sitios</a></li> 
